...
function injectAdvTrade(){
  ...
  for (var i in tradeTr) {
    ...
    if (tradeTd.length == 7) {
	  ...
	  var maxval = parseInt($x("./nobr", tradeTd[2])[0].lastChild.nodeValue); //максимум, который выставил продавец/покупатель
...
var TradeContainer = (function() {
    ...
    TradeContainer.prototype.init = function() {
        ...
        for (var i in elements) {
            ...
            this.registerResource(resId, arr[resId], elements[i]);
        }
    }
